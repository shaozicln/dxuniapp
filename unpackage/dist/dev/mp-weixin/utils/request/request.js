...
common_vendor.index.setStorageSync(
  "Admin-Token",
  "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhZG1pbiIsImxvZ2luX3VzZXJfa2V5IjoiNzgyNzA1MGYtNGY0MS00MGRiLWEzMjEtZDU3YjlhNTdiOTllIn0.13XYlQvudxBb1PEOxCliOweVrTERTEvhA8qQbAEoKj33XxmbkD1MEVaf7ORdSTop538z_xeS2l4yudlNibpE-Q"
);
const request = (options) => {
  ...
  common_vendor.index.__f__("log", "at utils/request/request.js:38", "请求URL:", fullUrl);
  common_vendor.index.__f__("log", "at utils/request/request.js:39", "请求头:", defaultHeaders);
